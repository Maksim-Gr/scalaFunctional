...
val gh = GitHubSettings(org = "com.github/Maksim-Gr", proj = "catsFunctional", publishOrg = "com.github/Maksim-Gr", license = apache2)
...
lazy val Catsfunctional = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "catsFunctional"),
    micrositeDocumentationUrl := "/catsFunctional/api/com.github/Maksim-Gr/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "com.github/Maksim-Gr"
  )
lazy val buildSettings = sharedBuildSettings(gh, libs)

lazy val commonSettings = addCompilerPlugins(libs, "kind-projector") ++ sharedCommonSettings ++ scalacAllSettings ++ Seq(
  organization := "com.github/Maksim-Gr",
